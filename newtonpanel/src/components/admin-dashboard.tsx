...
import { Settings, UserPlus, MonitorSmartphone, Target } from "lucide-react"
...
function DeviceAdder() {
  return (
    <Card>
      ...
      <CardContent>
        <p className="text-muted-foreground">Cihaz ekleme formu geliştiriliyor...</p>
      </CardContent>
    </Card>
  )
}
            ...
            {activeTab === "settings" && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Yönetici ayarları ve konfigürasyon</CardDescription>
                </CardHeader>
                <CardContent>
